...
class OrderListAdapter5(private val orderList: List<ThaiDish>) : RecyclerView.Adapter<OrderListAdapter5.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder:OrderListAdapter5.ViewHolder, position: Int) {
        val item:ThaiDish = orderList[position]
